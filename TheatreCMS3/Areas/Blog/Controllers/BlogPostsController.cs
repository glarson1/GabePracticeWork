...
namespace TheatreCMS3.Areas.Blog.Controllers
{
    public class BlogPostsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BlogPostId,Content,Posted,Author")] BlogPost blogPost)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BlogPostId,Content,Posted,Author")] BlogPost blogPost)
        {
            if (ModelState.IsValid)
            {
